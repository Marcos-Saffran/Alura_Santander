...
console.log("Bem-vindo ao desafio de lógica de programação com JavaScript!");
...
console.log(`A linguagem de programação que você mais gosta é: ${linguagemPreferida}`);
